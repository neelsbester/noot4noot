/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 7167fb4e517e3dae2245fb93e7f1db76)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAIL" | "ENVIRONMENT" | "SPOTIFY_CLIENT_ID">> {}
}
declare module "*.csv" {
	const value: string;
