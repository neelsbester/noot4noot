/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 7b3193ec359c63195a78ef8dbbe9ac96)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_AUD" | "ACCESS_TEAM_DOMAIN" | "ADMIN_EMAIL" | "ENVIRONMENT" | "SPOTIFY_CLIENT_ID">> {}
}
declare module "*.csv" {
	const value: string;
